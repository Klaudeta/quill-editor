...
public interface QuillToolbarConfigurator extends HasElement {
    ...
    /**
     * Configuring the editor to not include the ordered and bullet lists commands:
     *
     * @return this instance of the {@link QuillEditorComponent} as a QuillToolbarConfiguration
     */
    ...
    /**
     * Configuring the editor to not include the font and background color options:
     *
     * @return this instance of the {@link QuillEditorComponent} as a QuillToolbarConfiguration
     */
